...
git_sparse_clone main https://github.com/kenzok8/small-package luci-app-adguardhome luci-app-bypass luci-app-guest-wifi luci-app-timecontrol luci-app-control-timewol
# 添加easymesh
